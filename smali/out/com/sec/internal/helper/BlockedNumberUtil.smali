...
.method public static getBlockExpires(Landroid/content/Context;)J
    ...
    :try_end_10
    .catch Ljava/lang/IllegalArgumentException; {:try_start_2 .. :try_end_10} :catch_33
    .catch Ljava/lang/IllegalStateException; {:try_start_2 .. :try_end_10} :catch_33
    ...
    .catch Ljava/lang/IllegalStateException; {:try_start_28 .. :try_end_32} :catch_33
...
.method public static getBlockedNumbersList(Landroid/content/Context;)Ljava/util/Set;
    ...
    move-result-object p0
    :try_end_1a
    .catch Ljava/lang/IllegalArgumentException; {:try_start_7 .. :try_end_1a} :catch_4b
    ...
    invoke-interface {p0}, Landroid/database/Cursor;->close()V
    :try_end_4a
    .catch Ljava/lang/IllegalArgumentException; {:try_start_41 .. :try_end_4a} :catch_4b
...
.method public static getBlockedNumbersListFromNW(Landroid/content/Context;)Ljava/util/Set;
    ...
    move-result-object p0
    :try_end_20
    .catch Ljava/lang/IllegalArgumentException; {:try_start_a .. :try_end_20} :catch_76
    .catch Ljava/lang/IllegalStateException; {:try_start_a .. :try_end_20} :catch_76
    ...
    move-result v3
    :try_end_63
    .catchall {:try_start_22 .. :try_end_63} :catchall_66
    ...
    invoke-interface {p0}, Landroid/database/Cursor;->close()V
    :try_end_75
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6c .. :try_end_75} :catch_76
...
.method public static isBlockedNumber(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    move-result p0
    :try_end_c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1 .. :try_end_c} :catch_10
