...
.method private processSimAuthResponse(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "process3gppAuthResponse: failed to get SIM info"
    ...
    const-string v0, "process3gppAuthResponse: failed to generate challenge response"
    ...
    const-string v2, "process3gppAuthResponse: challenge response "
...
.method protected requestInitial3gppAuthentication(Landroid/os/Message;)V
    ...
    iget-object v8, p0, Lcom/sec/internal/ims/entitlement/nsds/ericssonnsds/flow/BaseFlowImpl;->mSimManager:Lcom/sec/internal/interfaces/ims/core/ISimManager;

    invoke-interface {v8}, Lcom/sec/internal/interfaces/ims/core/ISimManager;->getImsi()Ljava/lang/String;

    move-result-object v8

    iget-object v9, p0, Lcom/sec/internal/ims/entitlement/nsds/ericssonnsds/flow/BaseFlowImpl;->mSimManager:Lcom/sec/internal/interfaces/ims/core/ISimManager;

    invoke-interface {v9}, Lcom/sec/internal/interfaces/ims/core/ISimManager;->getSimOperator()Ljava/lang/String;

    move-result-object v9

    invoke-static {v0, v7, v8, v9}, Lcom/sec/internal/ims/entitlement/storagehelper/NSDSHelper;->getImsiEap(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
