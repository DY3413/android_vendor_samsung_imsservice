...
.field public static final request_alarm_wake_up:B = 0x6ft
...
.field public static final request_clear_all_call_internal:B = 0x75t
...
.field public static final request_handle_cmc_csfb:B = 0x5et

.field public static final request_handle_dtmf:B = 0x62t
...
.field public static final request_ish_accept_session:B = 0x60t

.field public static final request_ish_start_session:B = 0x5ft

.field public static final request_ish_stop_session:B = 0x61t
...
.field public static final request_ntp_time_offset:B = 0x72t

.field public static final request_open_sip_dialog:B = 0x6bt
...
.field public static final request_rtp_stats_to_stack:B = 0x69t

.field public static final request_send_cmc_info:B = 0x48t

.field public static final request_send_dm_state:B = 0x7at

.field public static final request_send_dtmf_event:B = 0x79t
...
.field public static final request_send_message_revoke_request:B = 0x68t

.field public static final request_send_msg:B = 0x21t

.field public static final request_send_negotiated_local_sdp:B = 0x7ct

.field public static final request_send_relay_event:B = 0x4et

.field public static final request_send_rp_ack_resp:B = 0x22t

.field public static final request_send_sip:B = 0x6at

.field public static final request_send_slm_file:B = 0x32t

.field public static final request_send_text:B = 0x63t
...
.field public static final request_set_video_crt_audio:B = 0x78t

.field public static final request_set_vowifi_5gsa_mode:B = 0x77t

.field public static final request_silent_log_enabled:B = 0x71t

.field public static final request_start_camera:B = 0x42t

.field public static final request_start_cmc_record:B = 0x76t

.field public static final request_start_ft_session:B = 0x2et

.field public static final request_start_im_session:B = 0x27t

.field public static final request_start_local_ring_back_tone:B = 0x6ct

.field public static final request_start_media:B = 0x2at

.field public static final request_start_record:B = 0x73t

.field public static final request_start_video_earlymedia:B = 0x5dt

.field public static final request_stop_camera:B = 0x43t

.field public static final request_stop_local_ring_back_tone:B = 0x6dt

.field public static final request_stop_record:B = 0x74t
...
.field public static final request_update_geolocation:B = 0x5ct
...
.field public static final request_update_sim_info:B = 0x6et
...
.field public static final request_update_vce_config:B = 0x67t

.field public static final request_update_xq_enable:B = 0xbt

.field public static final request_vsh_accept_session:B = 0x65t

.field public static final request_vsh_start_session:B = 0x64t

.field public static final request_vsh_stop_session:B = 0x66t

.field public static final request_x509_cert_verify_result:B = 0x70t

.field public static final request_xdm_fetch_document:B = 0x58t

.field public static final request_xdm_modify_contact:B = 0x5bt
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v91, "request_xdm_modify_contact"

    const-string/jumbo v92, "request_update_geolocation"

    const-string/jumbo v93, "request_start_video_earlymedia"

    const-string/jumbo v94, "request_handle_cmc_csfb"

    const-string/jumbo v95, "request_ish_start_session"

    const-string/jumbo v96, "request_ish_accept_session"

    const-string/jumbo v97, "request_ish_stop_session"

    const-string/jumbo v98, "request_handle_dtmf"

    const-string/jumbo v99, "request_send_text"

    const-string/jumbo v100, "request_vsh_start_session"

    const-string/jumbo v101, "request_vsh_accept_session"

    const-string/jumbo v102, "request_vsh_stop_session"

    const-string/jumbo v103, "request_update_vce_config"

    const-string/jumbo v104, "request_send_message_revoke_request"

    const-string/jumbo v105, "request_rtp_stats_to_stack"

    const-string/jumbo v106, "request_send_sip"

    const-string/jumbo v107, "request_open_sip_dialog"

    const-string/jumbo v108, "request_start_local_ring_back_tone"

    const-string/jumbo v109, "request_stop_local_ring_back_tone"

    const-string/jumbo v110, "request_update_sim_info"

    const-string/jumbo v111, "request_alarm_wake_up"

    const-string/jumbo v112, "request_x509_cert_verify_result"

    const-string/jumbo v113, "request_silent_log_enabled"

    const-string/jumbo v114, "request_ntp_time_offset"

    const-string/jumbo v115, "request_start_record"

    const-string/jumbo v116, "request_stop_record"

    const-string/jumbo v117, "request_clear_all_call_internal"

    const-string/jumbo v118, "request_start_cmc_record"

    const-string/jumbo v119, "request_set_vowifi_5gsa_mode"

    const-string/jumbo v120, "request_set_video_crt_audio"

    const-string/jumbo v121, "request_send_dtmf_event"

    const-string/jumbo v122, "request_send_dm_state"

    const-string/jumbo v123, "request_update_nr_sa_mode_on_start"

    const-string/jumbo v124, "request_send_negotiated_local_sdp"

    .line 133
    filled-new-array/range {v0 .. v124}, [Ljava/lang/String;
