...
.method protected HandleResponseForUpOther(Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;)Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;
    ...
    const-string v2, "retry after 24 hours, retryCount: "
    ...
    const-string v2, "set version to zero & retry after 24 hours, retryCount: "
    ...
    invoke-virtual {p0, v0, p2}, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->setToken(Ljava/lang/String;Lcom/sec/internal/constants/ims/DiagnosisConstants$RCSA_TDRE;)V
...
.method getMsisdnWithDialog()Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;
    ...
    invoke-virtual {v0, v3}, Lcom/sec/internal/ims/config/workflow/WorkflowMsisdnHandler;->setMsisdnSkipCount(I)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {p1, v4, v1}, Lcom/sec/internal/helper/DmConfigHelper;->getImsSwitchValue(Landroid/content/Context;Ljava/lang/String;I)I
...
.method protected isDataFullUpdateNeeded(Ljava/util/Map;)Z
    ...
    new-array v5, v2, [Lcom/sec/internal/constants/Mno;

    sget-object v6, Lcom/sec/internal/constants/Mno;->SWISSCOM:Lcom/sec/internal/constants/Mno;

    aput-object v6, v5, v4

    sget-object v6, Lcom/sec/internal/constants/Mno;->MTS_RUSSIA:Lcom/sec/internal/constants/Mno;

    aput-object v6, v5, v3

    .line 276
    invoke-virtual {v1, v5}, Lcom/sec/internal/constants/Mno;->isOneOf([Lcom/sec/internal/constants/Mno;)Z
    ...
    new-array v0, v2, [Lcom/sec/internal/constants/Mno;
    ...
    const-string v0, "root/application/1/services/ChatAuth"
...
.method protected setSharedInfoWithParamForUp()V
    ...
    invoke-virtual {v1, v3}, Lcom/sec/internal/ims/config/workflow/WorkflowCookieHandler;->handleCookie(Lcom/sec/internal/interfaces/ims/config/IHttpAdapter$Response;)V
    ...
    invoke-virtual {v1, v5, v3}, Lcom/sec/internal/ims/config/SharedInfo;->addHttpParam(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v5}, Lcom/sec/internal/ims/config/SharedInfo;->addHttpParam(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v5, v6, v7, v2}, Lcom/sec/internal/ims/config/workflow/WorkflowParamHandler;->getModelInfoFromCarrierVersion(Ljava/lang/String;Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    invoke-interface {v2, v3}, Lcom/sec/internal/interfaces/ims/config/ITelephonyAdapter;->getSubscriberId(I)Ljava/lang/String;
    ...
    const-string v3, "rcsProfile read and used : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->mRcsUPProfile:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->mRcsProvisioningVersion:Ljava/lang/String;

    const-string v5, "provisioning_version"
    ...
    const-string v3, "Provisioning version <-> RCS profile mismatch. Rcs profile is: "
    ...
    const-string v3, " Provisioning version is: "
    ...
    iget-object v3, p0, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->mRcsAppList:Ljava/util/List;
    ...
    invoke-virtual {v0, v4, v2}, Lcom/sec/internal/ims/config/SharedInfo;->addHttpParam(Ljava/lang/String;Ljava/lang/String;)V
