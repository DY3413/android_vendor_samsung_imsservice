...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/sec/internal/interfaces/ims/config/IConfigModule;Lcom/sec/internal/constants/Mno;Lcom/sec/internal/interfaces/ims/config/ITelephonyAdapter;Lcom/sec/internal/interfaces/ims/config/IStorageAdapter;Lcom/sec/internal/interfaces/ims/config/IHttpAdapter;Lcom/sec/internal/interfaces/ims/config/IXmlParserAdapter;Lcom/sec/internal/interfaces/ims/config/IDialogAdapter;I)V
    ...
    const-string p5, "rcs_client_platform"
    ...
    const-string p5, "rcs_client_version"
    ...
    const-string p5, "rcs_provisioning_version"
    ...
    const-string p6, "rcs_app_list"

    invoke-static {p3, p6, p5}, Lcom/sec/internal/ims/registry/ImsRegistry;->getStringArray(ILjava/lang/String;[Ljava/lang/String;)[Ljava/lang/String;
...
.method private registerGlobalSettingsObserver()V
    ...
    const-string v1, "rcs_custom_config_server_url"
...
.method protected getHttpResponse()Lcom/sec/internal/interfaces/ims/config/IHttpAdapter$Response;
    ...
    const-string v2, "request starts "
...
.method protected getToken(Ljava/util/Map;)Ljava/lang/String;
    ...
    const-string p0, "root/token/token"
...
.method protected getValidity(Ljava/util/Map;)I
    ...
    :try_start_0
    const-string p0, "root/vers/validity"
...
.method protected getVersionFromServer()I
    ...
    const-string v0, "root/vers/version_from_server"
...
.method protected getretryAfterTime()J
    ...
    const-string v2, "retry after related header "
...
.method protected handleRcsProfileChange(Ljava/lang/String;)V
    ...
    const-string v3, "rcs_application_server"
...
.method protected handleResponse(Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;I)Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;
    ...
    const-string p2, "set version to zero"
    ...
    invoke-virtual {p0, p1, v0}, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->setOpMode(Lcom/sec/internal/ims/config/workflow/WorkflowBase$OpMode;Ljava/util/Map;)V
...
.method protected handleResponse2(Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;)Lcom/sec/internal/ims/config/workflow/WorkflowBase$Workflow;
    ...
    invoke-virtual {p1, v3}, Lcom/sec/internal/ims/config/SharedInfo;->setUserMethod(Ljava/lang/String;)V
    ...
    const-string p1, "redirect location should be https instead of http"
    ...
    const-string p2, "set version to 0. retry next boot"
    ...
    invoke-virtual {p0, p1, v1}, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->setOpMode(Lcom/sec/internal/ims/config/workflow/WorkflowBase$OpMode;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v3}, Lcom/sec/internal/ims/config/SharedInfo;->setUserMethod(Ljava/lang/String;)V
...
.method protected initStorage()Z
    ...
    const-string v5, "initStorage: Telephony readiness check start."
    ...
    const-string v4, "rcs_application_server"
...
.method public removeValidToken()V
    ...
    const-string v2, "remove valid token"
...
.method protected scheduleAutoconfig(I)V
    ...
    const-string v1, "scheduleAutoconfig enter"
    ...
    const-string v3, "scheduleAutoconfig: getOpMode(): "
    ...
    const-string v5, "remainValidity="
...
.method protected sendConfigCompleteForPSOnlyNw()V
    ...
    const-string v1, "ps_only_network"
...
.method protected setNextAutoconfigTime(J)V
    ...
    const-string p2, "info/next_autoconfig_time"

    invoke-interface {p0, p2, p1}, Lcom/sec/internal/interfaces/ims/config/IStorageAdapter;->write(Ljava/lang/String;Ljava/lang/String;)Z
...
.method protected setToken(Ljava/lang/String;Lcom/sec/internal/constants/ims/DiagnosisConstants$RCSA_TDRE;)V
    ...
    const-string v2, ",reset ACS token. reason: "
