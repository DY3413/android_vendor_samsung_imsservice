...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/sec/internal/interfaces/ims/config/IConfigModule;Lcom/sec/internal/constants/Mno;I)V
    ...
    invoke-direct {v5, p2, v3, v12}, Lcom/sec/internal/ims/config/adapters/TelephonyAdapterPrimaryDeviceAtt;-><init>(Landroid/content/Context;Lcom/sec/internal/interfaces/ims/config/IConfigModule;I)V
    ...
    .line 151
    invoke-direct {p0, v12}, Lcom/sec/internal/ims/config/workflow/WorkflowAtt;->registerRcsUserSettingObserver(I)V
...
.method private getMsisdn()Ljava/lang/String;
    ...
    invoke-interface {p0}, Lcom/sec/internal/interfaces/ims/config/ITelephonyAdapter;->getMsisdn()Ljava/lang/String;
    ...
    const-string v1, "getMsisdn: use telephony msisdn"
...
.method private notifyRcsConfigurationReceived()V
    ...
    .line 218
    :goto_0
    invoke-interface {v0, v1, v2, p0}, Lcom/sec/internal/interfaces/google/IGoogleImsService;->notifyRcsAutoConfigurationErrorReceived(IILjava/lang/String;)V
    ...
    invoke-interface {v0, v2, p0}, Lcom/sec/internal/interfaces/google/IGoogleImsService;->notifyRcsPreConfigurationReceived(I[B)V
    ...
    invoke-interface {v0, v2, p0, v1}, Lcom/sec/internal/interfaces/google/IGoogleImsService;->notifyRcsAutoConfigurationReceived(I[BZ)V
...
.method private registerAirplaneModeObserver()V
    ...
    const-string v1, "registerAirplaneModeObserver"
...
.method private registerImsRegistrationListener()V
    ...
    const-string v1, "registerImsRegistrationListener failed"
...
.method private registerRcsUserSettingObserver(I)V
    ...
    const-string v1, "registerRcsUserSettingObserver"

    invoke-static {v0, p1, v1}, Lcom/sec/internal/log/IMSLog;->i(Ljava/lang/String;ILjava/lang/String;)V

    .line 90
    sget-object p1, Lcom/sec/internal/constants/ims/ImsConstants$SystemSettings;->RCS_USER_SETTING1:Lcom/sec/internal/constants/ims/ImsConstants$SystemSettings$SettingsItem;

    invoke-virtual {p1}, Lcom/sec/internal/constants/ims/ImsConstants$SystemSettings$SettingsItem;->getUri()Landroid/net/Uri;
    ...
    iget-object v2, p0, Lcom/sec/internal/ims/config/workflow/WorkflowAtt;->mRcsUserSettingObserver:Landroid/database/ContentObserver;
    ...
    .line 94
    iput-boolean p1, p0, Lcom/sec/internal/ims/config/workflow/WorkflowAtt;->isRcsUserSettingObserverRegistered:Z
...
.method private setRcsClientConfigurationforSec()V
    ...
    const-string v3, "rcs_client_version"
...
.method private startResetTokenTimer()V
    ...
    const-string/jumbo v0, "startResetTokenTimer: token doesn\'t exist, vail."
...
.method private stopResetTokenTimer()V
    ...
    const-string/jumbo v0, "stopResetTokenTimer: timer is not running."
...
.method private unregisterImsRegistrationListener()V
    ...
    .line 893
    iget-boolean v1, p0, Lcom/sec/internal/ims/config/workflow/WorkflowAtt;->isImsRegiListenerRegistered:Z
    ...
    .line 896
    iget-object v2, p0, Lcom/sec/internal/ims/config/workflow/WorkflowAtt;->mImsRegistrationListener:Lcom/sec/ims/IImsRegistrationListener;

    iget v3, p0, Lcom/sec/internal/ims/config/workflow/WorkflowBase;->mPhoneId:I

    invoke-interface {v1, v2, v3}, Lcom/sec/internal/interfaces/ims/core/IRegistrationManager;->unregisterListener(Lcom/sec/ims/IImsRegistrationListener;I)V

    const-string v1, "mImsRegistrationListener was unregistered"
    ...
    const-string/jumbo v1, "unregisterImsRegistrationListener failed"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v7, "rcsEnabledByUser"
    ...
    :cond_5
    const-string p1, "forced startAutoConfig"
    ...
    const-string p0, "AutoConfig:Already started"
...
.method initRcsClientConfiguration()V
    ...
    const-string v2, "Set RCS configuration For AM"
    ...
    const-string v2, "Set RCS configuration For SM"
    ...
    const-string v1, "Set RCS configuration For others"
...
.method protected setOpMode(Lcom/sec/internal/ims/config/workflow/WorkflowBase$OpMode;Ljava/util/Map;)V
    ...
    const-string p1, "Received XML has full config"
    ...
    const-string p1, "Received XML does NOT have full config with the same version"
    ...
    const-string v1, "Update validity"
    ...
    const-string p2, "Token is changed so update it"
    ...
    :cond_5
    const-string p1, "Received non-full XML and version is different: Ignore"
    ...
    :cond_6
    const-string p1, "null data. remain previous mode & data"
...
.method public setRcsClientConfiguration(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p1, "rcsEnabledByUser"
...
.method work()V
    ...
    const-string v5, ",FAIL,CON:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, p0, Lcom/sec/internal/ims/config/workflow/WorkflowAtt;->isFailedToConnect:Z
