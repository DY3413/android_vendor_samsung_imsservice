...
.method private handleCancelTransfer(Lcom/sec/internal/constants/ims/servicemodules/im/reason/CancelReason;)V
    ...
    const-class v3, Lcom/sec/internal/ims/servicemodules/im/FtHttpOutgoingMessage$FtHttpStateMachine$InProgressState;
    ...
    .line 584
    invoke-virtual {v4, v2}, Lcom/sec/internal/helper/StateMachine;->obtainMessage(I)Landroid/os/Message;
    ...
    .line 583
    invoke-virtual {v1, v3, v2, v4, v5}, Lcom/sec/internal/helper/PreciseAlarmManager;->sendMessageDelayed(Ljava/lang/String;Landroid/os/Message;J)Lcom/sec/internal/helper/DelayedMessage;
...
.method private handleUploadCanceled(Landroid/os/Message;)V
    ...
    invoke-virtual {p0, v1, v2, p1}, Lcom/sec/internal/helper/StateMachine;->obtainMessage(III)Landroid/os/Message;
...
.method private handleUploadCompleted(Ljava/lang/String;)V
    ...
    iget-object v4, v3, Lcom/sec/internal/ims/servicemodules/im/FtMessage;->mFileDisposition:Lcom/sec/internal/constants/ims/servicemodules/im/FileDisposition;
    ...
    iget-object v4, v4, Lcom/sec/internal/ims/servicemodules/im/FtMessage;->mContentUri:Landroid/net/Uri;

    invoke-static {v2, v4}, Lcom/sec/internal/ims/servicemodules/im/util/FileDurationUtil;->getFileDurationTime(Landroid/content/Context;Landroid/net/Uri;)I

    move-result v2

    div-int/lit16 v2, v2, 0x3e8

    iput v2, v3, Lcom/sec/internal/ims/servicemodules/im/FtMessage;->mPlayingLength:I
    ...
    iget v2, v2, Lcom/sec/internal/ims/servicemodules/im/FtMessage;->mPlayingLength:I
    ...
    .line 649
    new-instance v2, Lcom/sec/internal/ims/servicemodules/im/util/FtHttpXmlComposer;

    invoke-direct {v2}, Lcom/sec/internal/ims/servicemodules/im/util/FtHttpXmlComposer;-><init>()V
    ...
    iget v4, v3, Lcom/sec/internal/ims/servicemodules/im/FtMessage;->mPlayingLength:I

    invoke-interface {v2, p1, v4}, Lcom/sec/internal/ims/servicemodules/im/interfaces/IFtHttpXmlComposer;->composeXmlForAudioMessage(Lcom/sec/internal/constants/ims/servicemodules/im/FtHttpFileInfo;I)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v3, Lcom/sec/internal/ims/servicemodules/im/MessageBase;->mBody:Ljava/lang/String;
