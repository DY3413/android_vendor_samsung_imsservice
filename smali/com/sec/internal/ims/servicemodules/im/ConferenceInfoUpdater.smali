...
.method private downloadGroupIcon(Lcom/sec/internal/constants/ims/servicemodules/im/ImIconData;)V
    ...
    const-string v3, "received_files"
...
.method private participantStatusUpdated(Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;)V
    ...
    const-string v0, "remove_failed_participant_groupchat"
...
.method public findAbsentParticipant(Lcom/sec/internal/constants/ims/servicemodules/im/event/ImSessionConferenceInfoUpdateEvent;)V
    ...
    iget-object v4, v4, Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;->mUri:Lcom/sec/ims/util/ImsUri;

    invoke-virtual {v5, v4}, Lcom/sec/ims/util/ImsUri;->equals(Ljava/lang/Object;)Z
...
.method protected onConferenceInfoUpdated(Lcom/sec/internal/constants/ims/servicemodules/im/event/ImSessionConferenceInfoUpdateEvent;Ljava/lang/String;)V
    ...
    invoke-interface {v3, v4}, Lcom/sec/internal/ims/servicemodules/im/interfaces/IGetter;->normalizeUri(Lcom/sec/ims/util/ImsUri;)Lcom/sec/ims/util/ImsUri;

    move-result-object v3

    iput-object v3, v1, Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;->mUri:Lcom/sec/ims/util/ImsUri;

    .line 102
    iget-boolean v4, v1, Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;->mIsOwn:Z

    if-nez v4, :cond_8

    iget-object v4, p0, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->mOwnUri:Lcom/sec/ims/util/ImsUri;
    ...
    invoke-virtual {v3, v4}, Lcom/sec/internal/ims/servicemodules/im/ImSession;->getParticipant(Lcom/sec/ims/util/ImsUri;)Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;

    move-result-object v3

    .line 108
    invoke-static {v1, v3}, Lcom/sec/internal/ims/servicemodules/im/translator/TranslatorCollection;->translateEngineParticipantInfo(Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;)Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;
    ...
    .line 111
    invoke-direct {p0, v1, v4}, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->newParticipantAdded(Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;)V

    goto :goto_0

    .line 113
    :cond_3
    invoke-virtual {v3}, Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;->getStatus()Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;
    ...
    .line 116
    invoke-direct {p0, v1, v3, v4, v5}, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->participantStatusUpdated(Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Status;)V

    .line 119
    :cond_4
    iget-boolean v2, v1, Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;->mIsChairman:Z
    ...
    :cond_5
    sget-object v2, Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Type;->REGULAR:Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Type;

    .line 120
    :goto_1
    invoke-virtual {v3}, Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;->getType()Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Type;
    ...
    .line 121
    iput-boolean v4, p0, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->mIsLeaderChange:Z

    .line 122
    iget-object v4, p0, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->mImSession:Lcom/sec/internal/ims/servicemodules/im/ImSession;

    const-string v5, "onConferenceInfoUpdated, mIsLeaderChange=true."

    invoke-virtual {v4, v5}, Lcom/sec/internal/helper/StateMachine;->logi(Ljava/lang/String;)V

    .line 123
    invoke-virtual {v3, v2}, Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;->setType(Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant$Type;)V

    .line 124
    iget-object v4, p0, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->mUpdatedParticipants:Ljava/util/Set;
    ...
    iput-object v2, p0, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->mNewLeader:Ljava/lang/String;

    .line 130
    :cond_6
    iget-object v2, v1, Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;->mDispName:Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;->getUserAlias()Ljava/lang/String;
    ...
    .line 131
    iget-object v1, v1, Lcom/sec/internal/constants/ims/servicemodules/im/ImConferenceParticipantInfo;->mDispName:Ljava/lang/String;

    invoke-virtual {v3, v1}, Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;->setUserAlias(Ljava/lang/String;)V

    .line 132
    iget-object v1, p0, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->mUpdatedParticipants:Ljava/util/Set;
    ...
    invoke-interface {v1, v2, v3}, Lcom/sec/internal/ims/servicemodules/im/listener/ImSessionListener;->onParticipantAliasUpdated(Ljava/lang/String;Lcom/sec/internal/constants/ims/servicemodules/im/ImParticipant;)V
    ...
    .line 159
    iget-object p1, p1, Lcom/sec/internal/constants/ims/servicemodules/im/event/ImSessionConferenceInfoUpdateEvent;->mIconData:Lcom/sec/internal/constants/ims/servicemodules/im/ImIconData;

    invoke-virtual {p0, p1}, Lcom/sec/internal/ims/servicemodules/im/ConferenceInfoUpdater;->onGroupChatIconUpdated(Lcom/sec/internal/constants/ims/servicemodules/im/ImIconData;)V
