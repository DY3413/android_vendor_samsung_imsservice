...
.method private sendGetRequest(I)I
    ...
    const-string v4, " neither OK nor UNAUTHORIZED"
    ...
    invoke-virtual {v4}, Lcom/sec/internal/helper/HttpRequest;->wwwAuthenticate()Ljava/lang/String;
    ...
    .line 321
    invoke-static {v0, v5, v4, v6, v7}, Lcom/sec/internal/ims/util/HttpAuthGenerator;->getAuthorizationHeader(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, v4, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadRequest;->mUrl:Ljava/lang/String;

    invoke-static {v4}, Lcom/sec/internal/helper/HttpRequest;->get(Ljava/lang/CharSequence;)Lcom/sec/internal/helper/HttpRequest;

    move-result-object v4

    iput-object v4, p0, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask;->mHttpRequest:Lcom/sec/internal/helper/HttpRequest;
    ...
    const-string v0, "sendGetRequest: OpenId Process failed!"
    ...
    invoke-interface {p1, v0, v2, v2}, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadTaskCallback;->onCanceled(Lcom/sec/internal/constants/ims/servicemodules/im/reason/CancelReason;II)V
    :try_end_2
    ...
    invoke-virtual {v5, v6}, Lcom/sec/internal/helper/HttpRequest;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/sec/internal/helper/HttpRequest;->body()Ljava/lang/String;
    ...
    invoke-static {v6, v5}, Lcom/sec/internal/ims/util/HttpAuthGenerator;->getEAPAkaChallengeResponse(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/sec/internal/helper/HttpRequest;->post(Ljava/lang/CharSequence;)Lcom/sec/internal/helper/HttpRequest;
    ...
    invoke-virtual {p1, v5}, Lcom/sec/internal/helper/HttpRequest;->send(Ljava/lang/CharSequence;)Lcom/sec/internal/helper/HttpRequest;
    ...
    invoke-interface {p0, p1, v1, v2}, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadTaskCallback;->onCanceled(Lcom/sec/internal/constants/ims/servicemodules/im/reason/CancelReason;II)V
    ...
    invoke-interface {p0, p1, v2, v2}, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadTaskCallback;->onCanceled(Lcom/sec/internal/constants/ims/servicemodules/im/reason/CancelReason;II)V
    ...
    invoke-interface {p0, v0, v1, v2}, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadTaskCallback;->onCanceled(Lcom/sec/internal/constants/ims/servicemodules/im/reason/CancelReason;II)V
...
.method protected doInBackground()Ljava/lang/Long;
    ...
    .line 115
    iget-object v3, p0, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask;->mRequest:Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadRequest;

    iget-wide v6, v3, Lcom/sec/internal/ims/servicemodules/im/DownloadFileTask$DownloadRequest;->mTotalBytes:J
