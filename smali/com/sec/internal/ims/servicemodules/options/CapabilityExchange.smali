...
# direct methods
.method public static synthetic $r8$lambda$lg_SeokOVth5EObQ7thtqBrfgcg(Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;IZ)V
    .locals 0
...
.method private synthetic lambda$fillPollingList$0(IZ)V
    ...
    invoke-virtual {v0, v3, v6, v12, v1}, Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;->updatePollList(Ljava/util/Set;Lcom/sec/ims/util/ImsUri;ZI)Z
    ...
    :goto_3
    sput-wide v6, Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;->mPollingPartialCount:J
    ...
    invoke-virtual {v2, v1, v4}, Lcom/sec/internal/helper/SimpleEventLog;->logAndAdd(ILjava/lang/String;)V

    .line 440
    iget-object v2, v0, Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;->mCapabilityDiscovery:Lcom/sec/internal/ims/servicemodules/options/CapabilityDiscoveryModule;

    invoke-virtual {v2, v6, v7, v11, v1}, Lcom/sec/internal/ims/servicemodules/options/CapabilityDiscoveryModule;->startPartialPollingTimer(JZI)V

    .line 442
    :cond_6
    iget-object v2, v0, Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;->mEventLog:Lcom/sec/internal/helper/SimpleEventLog;

    const-string v4, "fillPollingList: E"
    ...
    invoke-virtual {v0, v2, v12, v13, v1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method delayPoll(ILjava/util/Date;)V
    ...
    .line 125
    sput-wide v3, Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;->mPollingPartialCount:J
...
.method forcePoll(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/sec/internal/ims/servicemodules/options/CapabilityDiscoveryModule;->stopPartialPollingTimer(I)V

    const-wide/16 v2, 0x0

    .line 401
    sput-wide v2, Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange;->mPollingPartialCount:J
...
.method poll(Landroid/content/Context;ZZILjava/util/Map;Ljava/util/List;)V
    ...
    const-string v3, "poll: isPeriodic = "
    ...
    const-string v0, "poll: no uris to request"
...
.method requestCapabilityExchange(Ljava/util/Set;Lcom/sec/internal/constants/ims/servicemodules/options/CapabilityConstants$RequestType;II)I
    ...
    const-string v2, "requestCapabilityExchange: "
    ...
    const-string v4, "requestCapabilityExchange internalRequestId : "
    ...
    const-string v5, "requestCapabilityExchange: remove notAllowedUris = "
...
.method requestCapabilityExchange(Lcom/sec/ims/util/ImsUri;Lcom/sec/internal/constants/ims/servicemodules/options/CapabilityConstants$RequestType;ZILcom/sec/ims/options/Capabilities;Lcom/sec/internal/interfaces/ims/core/IRegistrationManager;Ljava/util/Map;Ljava/lang/String;II)Z
    ...
    const-string v5, "requestCapabilityExchange: uri = "
    ...
    const-string v7, "requestCapabilityExchange: "
...
.method requestCapabilityForOptions(ILjava/util/Date;Ljava/util/List;)Z
    ...
    const-string v1, "requestCapabilityForOptions:"
    ...
    const-string p3, "poll: room is 0"
    ...
    const-string v1, "poll: remained mUrisToRequest size: "
...
.method requestCapabilityForPresence(IZLjava/util/Date;)Z
    ...
    const-string v1, "requestCapabilityForPresence:"
    ...
    .line 221
    :goto_1
    invoke-virtual {v3, v0, v4, p1, v1}, Lcom/sec/internal/ims/servicemodules/options/CapabilityDiscoveryModule;->requestCapabilityExchange(Ljava/util/Set;Lcom/sec/internal/constants/ims/servicemodules/options/CapabilityConstants$RequestType;II)I
    ...
    const-string v0, "poll: remained mUrisToRequest size: "
...
.method requestInitialCapabilitiesQuery(IZJ)V
    ...
    const-string v1, "requestInitialCapabilitiesQuery:"
    ...
    const-string p3, "requestInitialCapabilitiesQuery: disable initial scan"
    ...
    invoke-virtual {v1, p1}, Lcom/sec/internal/ims/servicemodules/options/ContactCache;->isReady(I)Z
    ...
    const-string p2, "requestInitialCapabilitiesQuery: contact is not ready. retry in 1 second."
    ...
    const-string v5, "requestInitialCapabilitiesQuery: current "
    ...
    const-string p0, "requestInitialCapabilitiesQuery: Polling already in progress"
    ...
    const-string p2, "requestInitialCapabilitiesQuery: Polling has not been performed yet, start polling"
    ...
    invoke-virtual {p0, v1, p1}, Lcom/sec/internal/ims/servicemodules/options/CapabilityDiscoveryModule;->startPoll(Ljava/util/Date;I)V
    ...
    :cond_9
    :goto_0
    const-string p2, "requestInitialCapabilitiesQuery: not ready. retry in 1 second."
...
.method startThrottledRetryTimer(Landroid/content/Context;ZJI)V
    ...
    invoke-virtual {p0, v0, v1, v1, p5}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object p0

    .line 489
    invoke-virtual {p1, p2, p0, p3, p4}, Lcom/sec/internal/helper/PreciseAlarmManager;->sendMessageDelayed(Ljava/lang/String;Landroid/os/Message;J)Lcom/sec/internal/helper/DelayedMessage;
...
.method updatePollList(Ljava/util/Set;Lcom/sec/ims/util/ImsUri;ZI)Z
    ...
    const-string/jumbo v1, "updatePollList: uri = "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v1, ", needAdd = "
    ...
    invoke-static {p0, p4, v0}, Lcom/sec/internal/log/IMSLog;->s(Ljava/lang/String;ILjava/lang/String;)V
...
.method validateCapexRequest(Lcom/sec/ims/util/ImsUri;ILcom/sec/internal/interfaces/ims/core/IRegistrationManager;Ljava/util/Map;)Lcom/sec/internal/ims/servicemodules/options/CapabilityExchange$Result;
    ...
    const-string p0, "requestCapabilityExchange: mnoStrategy is null."
    ...
    const-string p0, "requestCapabilityExchange: isAllowedPrefixesUri and hasChatbotRoleSession are false."
    ...
    const-string p0, "requestCapabilityExchange: isPresenceValidUri is false."
    ...
    const-string p0, "remove user=phone param for chatbot serviceId"
    ...
    :cond_8
    :goto_0
    const-string p0, "requestCapabilityExchange: mRegMan or ImsRegistration is null"
    ...
    :cond_9
    :goto_1
    const-string p0, "requestCapabilityExchange: uri or mControl is null"
