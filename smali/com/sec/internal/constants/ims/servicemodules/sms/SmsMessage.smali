...
.method private encodeCdmaAddress(I)[B
    ...
    .line 697
    iget v3, p0, Lcom/sec/internal/constants/ims/servicemodules/sms/SmsMessage;->mNetworktype:I

    invoke-virtual {v0, p1, v3}, Lcom/android/internal/util/BitwiseOutputStream;->write(II)V
...
.method private getGsmAddress()Ljava/lang/String;
    ...
    .line 579
    :cond_1
    invoke-static {v4, p0, v2}, Landroid/telephony/PhoneNumberUtils;->calledPartyBCDToString([BII)Ljava/lang/String;
...
.method private getSCAddress()Ljava/lang/String;
    ...
    .line 599
    invoke-static {v2, v3, v0}, Landroid/telephony/PhoneNumberUtils;->calledPartyBCDToString([BII)Ljava/lang/String;
