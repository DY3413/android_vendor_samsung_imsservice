...
# direct methods
.method public static synthetic $r8$lambda$0Q4sd-3OWyvS0RNUeu0nFB0ib2I(Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;Landroid/os/PersistableBundle;Lcom/google/gson/JsonElement;)V
    .locals 0
...
.method public static synthetic $r8$lambda$uY-iF-3X9ITNA3__jW8YOmbTyQE(I)[Ljava/lang/String;
    .locals 0
...
.method static constructor <clinit>()V
    ...
    const-string v1, "PUBLISH_SERVICE_DESC_FEATURE_TAG_MAP_OVERRIDE"

    const/4 v2, 0x0

    const-string v3, "publish_service_desc_feature_tag_map_override_string_array"

    const-string v4, "ims.publish_service_desc_feature_tag_map_override_string_array"

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 17
    new-instance v1, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;

    const-string v3, "RCS_FEATURE_TAG_ALLOWED"

    const/4 v4, 0x1

    const-string v5, "rcs_feature_tag_allowed_string_array"

    const-string v6, "ims.rcs_feature_tag_allowed_string_array"

    invoke-direct {v1, v3, v4, v5, v6}, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v1, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;->RCS_FEATURE_TAG_ALLOWED:Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;

    const/4 v3, 0x2

    new-array v3, v3, [Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;
    ...
    .line 14
    sput-object v3, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;->$VALUES:[Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;
...
.method private synthetic lambda$putOverrideConfig$1(Landroid/os/PersistableBundle;Lcom/google/gson/JsonElement;)V
    ...
    new-instance v1, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig$$ExternalSyntheticLambda0;-><init>()V
    ...
    const-string v1, "putOverrideConfig: "
...
.method public putOverrideConfig(Landroid/os/PersistableBundle;Lcom/google/gson/JsonObject;)V
    ...
    new-instance v0, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p1}, Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig$$ExternalSyntheticLambda2;-><init>(Lcom/sec/internal/constants/ims/config/StringArrayCarrierConfig;Landroid/os/PersistableBundle;)V
